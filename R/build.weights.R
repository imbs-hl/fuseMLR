#' Build Weights for COBRA Predictions
#'
#' The \code{build_weights} function is used to calculate weights for predictions
#' when (\code{calib = TRUE}).
#'
...
build_weights <- function(train, test, n_train, n_test,
                          nlearners, eps) {
