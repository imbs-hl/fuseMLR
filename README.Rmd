...
[![CRAN v0.0.1](https://www.r-pkg.org/badges/version/fuseMLR)](https://cran.r-project.org/web/packages/fuseMLR/)
...
Refer to our vignette to understand [how fuseMLR works](https://cran.r-project.org/web/packages/fuseMLR/vignettes/fuseMLR.html).
