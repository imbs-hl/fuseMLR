...
```{r, echo=FALSE, fig.cap="Package architecture", out.width="70%", out.height="100%"}
knitr::include_graphics("README_files/figure-gfm/fuseMLR_4_blue_bgr.pdf")
```
...
```{r performance_non_overlap, include=TRUE, eval=TRUE}
