...
[![Lifecycle: Stable](https://img.shields.io/badge/lifecycle-Maturing-orange.svg)](https://lifecycle.r-lib.org/articles/stages.html#Maturing)
...
`fuseMLR` is an object-oriented package based on `R6` version 2.5.1. Refer to the [vignette]() for a quick overview of how to use the package.
