...
Also add a meta-layer. We use the weighted mean (internal function to `fuseMLR`) as meta-learner. However, any other learner can be used as described in [Appendix](#appendix).
