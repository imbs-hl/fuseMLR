...
save(entities, file = file.path(dirname(dirname(this.path::this.path())), "data/entities.rda"))
# Compress this large dataset.
tools::resaveRdaFiles(paths = file.path(dirname(dirname(this.path::this.path())), "data/entities.rda"))
